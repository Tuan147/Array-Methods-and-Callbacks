...
function getFinals(data) {
  const everyFinal = data.filter(item => item['Stage'] === 'Final'
    );
    return everyFinal;
}
...
//we don't care about overtime just compare the points!
...
Use the higher order function getAverageGoals to do the following: 
 ...
 2. Return the the average number of the total home team goals and away team goals scored per match and round to the second decimal place. .toFixed(2);
